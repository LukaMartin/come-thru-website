        ...
        <section className="grid gap-4">
          ...
          {events.map((event) => (
            <Link
              ...
              className="group grid gap-4 border border-[#f3eadb]/14 bg-[radial-gradient(circle_at_18%_18%,rgba(172,67,43,0.12),transparent_34%),#080706] p-5 transition hover:border-[#d7c7ad]/45 md:grid-cols-[1fr_auto]"
            >
              <div>
